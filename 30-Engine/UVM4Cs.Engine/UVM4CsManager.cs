    ...
    public class UVM4CsManager
    {
            ...
            List<UVM4CsCsproj> modifiedFiles)
        {
            ...
            foreach (List<UVM4CsCsproj> filesToUpdateOrderedSub in filesToUpdateOrdered)
            {
                ...
                UVMLogger.AddLogListVF(ADCGLogLevelType.TRACE, title, preface, filesToUpdateOrderedSubCasted);
            }
            ...
            Int32 maxIter)
        {
            ...
            if (nbIter > maxIter)
            {
                ...
                UVMLogger.AddLog(ADCGLogLevelType.ERROR, titleMaxIter, prefaceMaxIter);
            ...
            UVMLogger.AddLogListVF(ADCGLogLevelType.TRACE, title, preface, vfToUpdateCurrentLayerCasted);
